...
int find_Reflective_Pair(int array[],int x,int plithos);
...
int find_Reflective_Pair(int array[],int x,int plithos) // recursive function find_Reflective_Pair
{
	int a = (plithos/2);
	if(x <= a)
	{
